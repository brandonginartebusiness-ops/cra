          ...
          >
            {serviceCards.map((s) => (
              ...
              >
                <Link
                  href={s.href}
                  className="group block bg-[#16161f] border border-white/5 rounded-2xl overflow-hidden hover:shadow-[0_8px_40px_rgba(59,130,246,0.12)] hover:border-[#3b82f6]/20 transition-all duration-300"
                >
