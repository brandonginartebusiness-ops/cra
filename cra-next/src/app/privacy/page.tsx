  ...
  return (
    <main className="bg-[#faf8f5] min-h-screen pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="text-sm text-[#8888a0] mb-12">Last updated: {updated}</p>

        <div className="flex flex-col gap-10 text-[#5a5a72] leading-relaxed text-sm">

          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">1. Who We Are</h2>
            <p>
              ...
              We operate the website <strong className="text-[#1a1a2e]">claimremedyadjusters.com</strong> and
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">3. How We Use Your Information</h2>
            ...
            <p className="mt-3">
              We do <strong className="text-[#1a1a2e]">not</strong> sell your personal information to third parties.
            </p>
          </section>

          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">4. AI Chat Assistant</h2>
            <p>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">5. Instagram and Social Media</h2>
            <p>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">7. Data Sharing</h2>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">8. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">9. Your Rights</h2>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">10. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-bebas text-2xl text-[#1a1a2e] mb-3">11. Changes to This Policy</h2>
            <p>
