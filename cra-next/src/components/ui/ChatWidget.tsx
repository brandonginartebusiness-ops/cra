      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[360px] max-w-[calc(100vw-1.5rem)] flex flex-col rounded-2xl overflow-hidden shadow-[0_8px_48px_rgba(0,0,0,0.14)] border border-[#1a1a2e]/10"
            style={{ height: "min(540px, calc(100vh - 8rem))" }}
          >
            {/* Header */}
            <div className="bg-[#faf8f5] border-b border-[#1a1a2e]/10 px-4 py-3 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-[#1a1a2e] leading-none">Claim Remedy AI</p>
                <p className="text-xs text-[#0d9488] mt-0.5">Free claim guidance · No obligation</p>
              </div>
              <div className="ml-auto flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#0d9488] animate-pulse" />
                <span className="text-xs text-[#8888a0]">Online</span>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto bg-[#faf8f5] px-4 py-4 flex flex-col gap-3">
                  ...
                  <div
                    className={`max-w-[82%] px-3.5 py-2.5 rounded-2xl text-sm leading-relaxed ${
                      msg.role === "user"
                        ...
                        : "bg-[#ffffff] text-[#1a1a2e] rounded-bl-sm border border-[#1a1a2e]/8"
                    }`}
              ...
              {loading && (
                <div className="flex justify-start">
                  <div className="bg-[#ffffff] border border-[#1a1a2e]/8 rounded-2xl rounded-bl-sm px-4 py-3 flex gap-1.5 items-center">
                    {[0, 0.2, 0.4].map((delay, i) => (
                      <span
                        key={i}
                        className="w-1.5 h-1.5 rounded-full bg-[#8888a0]"
                        style={{
            ...
            {/* Input */}
            <div className="bg-[#faf8f5] border-t border-[#1a1a2e]/10 px-3 py-3 flex gap-2 items-end">
              <textarea
                ref={inputRef}
                value={input}
                onChange={(e) => {
