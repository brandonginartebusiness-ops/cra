            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-1.5 bg-white/5 border border-white/10 text-[#f0f0f5] text-xs font-semibold px-4 py-2.5 rounded-full hover:border-white/20 transition-colors whitespace-nowrap"
                >
                ...
                <Link
                  href="/contact"
                  onClick={onClose}
                  className="flex-1 inline-flex items-center justify-center bg-[#3b82f6] text-white text-xs font-semibold px-4 py-2.5 rounded-full hover:opacity-90 transition-opacity whitespace-nowrap"
                >
