        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          >
            <a
              ...
              className="block bg-[#16161f] border border-white/5 rounded-2xl p-8 hover:scale-[1.02] hover:shadow-[0_8px_40px_rgba(59,130,246,0.12)] hover:border-[#3b82f6]/20 transition-all duration-300"
            >
              {/* Tag */}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-[#25d366] text-white font-semibold px-7 py-3.5 rounded-full hover:opacity-90 hover:shadow-[0_0_24px_rgba(37,211,102,0.3)] transition-all duration-300"
              >
